...
const CreateLocationPage = () => {
  ...
  const { mutate: createLocation, isPending } = useMutation({
    mutationFn: (input: CreateLocationInput) =>
      locationApi.createLocation(input),
    onSuccess: () => {
  ...
  return (
    <>
      <PageMeta
        title={PAGE_META_DATA.locationNew.title}
        description={PAGE_META_DATA.locationNew.description}
      />
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Create a new warehouse or branch
            </p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-5 max-w-md">
                <div className="space-y-1.5">
                  ...
                  <Input
                    id="name"
                    placeholder="e.g. Accra Central Warehouse"
                    value={form.name}
                    onChange={(e) =>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((prev) => ({
                        ...prev,
                        type: e.target.value as CreateLocationInput["type"],
                      }))
                    }
                    disabled={isPending}
